...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/bootstrap.min.css" crossorigin="anonymous">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/dataTables.bootstrap4.min.css" crossorigin="anonymous">
